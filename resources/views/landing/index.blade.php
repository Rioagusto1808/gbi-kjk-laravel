...
@section('content')
    ...
    <section id="visi-misi" class="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
            <img src="/images/visi.jpg" alt="Visi Misi" class="rounded-lg shadow">
        </div>
        <div>
            <div class="mb-6">
                ...
                <p class="lg:text-xl font-bold text-black mt-2">Visi Kualitatif: Jemaat GBI di seluruh dunia diarahkan untuk
                    semakin serupa dengan Kristus.</p>
                <p class="lg:text-xl font-bold text-black mt-2">Visi Kuantitatif: Mencapai 10.000 jemaat GBI di seluruh
                    dunia.</p>
            </div>
            <div>
                <h3 class="lg:text-4xl text-2xl font-semibold">MISI</h3>
                <p class="lg:text-2xl text-xl font-bold text-blue-800 mt-2"></p>
    ...
    <section id="tentang-gbi" class="relative bg-gray-900 text-white py-20 bg-cover bg-center"
        ...
        <div class="relative container mx-auto px-6 text-center max-w-3xl">
            <h2 class="text-4xl font-bold mb-6">Tentang GBI</h2>
    ...
    <section id="kontak" class="container bg-gray-200 mx-auto px-6 py-12">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <x-message />
            {{-- Form Kontak --}}
            <form action="{{ route('kontak.store') }}" method="POST" class="bg-white p-6 shadow rounded">
                @csrf
                <div class="mb-4">
