    ...
    <div class="mb-4">
        <form method="GET" action="{{ route('jemaat.index') }}" class="flex sm:flex-row items-center gap-2">
            ...
            <div class="relative w-full sm:w-64">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari jemaat..."
                ...
                @forelse ($jemaat as $index => $j)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @else
                                <span
                                    class="px-3 py-1 inline-flex text-xs font-semibold rounded-full bg-red-100 text-red-700">
                                    Nonaktif
                                </span>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right space-x-2">
                            ...
                            <form id="delete-form-{{ $j->id }}" action="{{ route('jemaat.destroy', $j->id) }}"
