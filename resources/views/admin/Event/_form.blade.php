...
<div>
    ...
    <x-text-input id="nama_event" type="text" name="nama_event" value="{{ old('nama_event', $event->nama_event ?? '') }}"
...
<div>
    ...
    <x-text-input id="tema" type="text" name="tema" value="{{ old('tema', $event->tema ?? '') }}"
        class="w-full mt-1" />
...
<div>
    ...
    <input type="file" id="image" name="image" class="w-full mt-1 border-gray-300 rounded-md" />
...
<div>
    ...
    <textarea id="deskripsi" name="deskripsi" rows="4" class="w-full mt-1 border-gray-300 rounded-md">{{ old('deskripsi', $event->deskripsi ?? '') }}</textarea>
...
<div>
    ...
    <x-text-input id="lokasi" type="text" name="lokasi" value="{{ old('lokasi', $event->lokasi ?? '') }}"
        class="w-full mt-1" />
...
<div>
    ...
    <x-text-input id="biaya" type="number" step="0.01" name="biaya"
        value="{{ old('biaya', $event->biaya ?? 0) }}" class="w-full mt-1" />
...
<div class="flex gap-2 justify-end">
    <a href="{{ route('event.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">Batal</a>
