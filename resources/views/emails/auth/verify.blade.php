...
<head>
    <meta charset="utf-8">
    <title>Verifikasi Email - GBI KJK</title>
</head>
                    ...
                    <tr>
                        <td style="padding:24px; color:#374151;">
                            ...
                            <p style="margin:0 0 16px;">
                                Terima kasih telah mendaftar di <strong>GBI KJK</strong>.
                            ...
                            <p style="margin:0 0 8px; font-size:13px; color:#6b7280;">
                                Jika tombol di atas tidak berfungsi, salin dan tempel URL ini di browser Anda:
                            </p>
